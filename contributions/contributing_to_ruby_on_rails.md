...
* [x] How to use GitHub to report issues.
* [x] How to clone main and run the test suite.
* [x] How to help resolve existing issues.
* [x] How to contribute to the Ruby on Rails documentation.
* [x] How to contribute to the Ruby on Rails code.
