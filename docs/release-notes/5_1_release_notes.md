...
* [x] Yarn Support
* [x] Optional Webpack support
* [x] jQuery no longer a default dependency
* [x] System tests
* [x] Encrypted secrets
* [x] Parameterized mailers
* [x] Direct & resolved routes
* [x] Unification of form_for and form_tag into form_with
