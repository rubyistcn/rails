...
* [x] Brand new router with an emphasis on RESTful declarations
* [x] New Action Mailer API modeled after Action Controller (now without the agonizing pain of sending multipart messages!)
* [x] New Active Record chainable query language built on top of relational algebra
* [x] Unobtrusive JavaScript helpers with drivers for Prototype, jQuery, and more coming (end of inline JS)
* [x] Explicit dependency management with Bundler
