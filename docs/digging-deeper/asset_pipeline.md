...
* [x] What the asset pipeline is and what it does.
* [x] How to properly organize your application assets.
* [x] The benefits of the asset pipeline.
* [x] How to add a pre-processor to the pipeline.
* [x] How to package assets with a gem.
