...
* [x] What are `classic` and `zeitwerk` modes
* [x] Why switch from `classic` to `zeitwerk`
* [x] How to activate `zeitwerk` mode
* [x] How to verify your application runs in `zeitwerk` mode
* [x] How to verify your project loads OK in the command line
* [x] How to verify your project loads OK in the test suite
* [x] How to address possible edge cases
* [x] New features in Zeitwerk you can leverage
