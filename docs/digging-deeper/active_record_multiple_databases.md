...
* [x] How to set up your application for multiple databases.
* [x] How automatic connection switching works.
* [x] How to use horizontal sharding for multiple databases.
* [x] What features are supported and what's still a work in progress.
