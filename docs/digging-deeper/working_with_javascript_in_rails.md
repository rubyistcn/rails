...
* [x] How to use Rails without the need for a Node.js, Yarn, or a JavaScript bundler.
* [x] How to create a new Rails application using import maps, esbuild, rollup, or webpack to bundle
your JavaScript.
* [x] What Turbo is, and how to use it.
* [x] How to use the Turbo HTML helpers provided by Rails.
