...
* [x] What Action Cable is and its integration backend and frontend
* [x] How to set up Action Cable
* [x] How to set up channels
* [x] Deployment and Architecture setup for running Action Cable
