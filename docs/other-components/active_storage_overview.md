...
* [x] How to attach one or many files to a record.
* [x] How to delete an attached file.
* [x] How to link to an attached file.
* [x] How to use variants to transform images.
* [x] How to generate an image representation of a non-image file, such as a PDF or a video.
* [x] How to send file uploads directly from browsers to a storage service,
  bypassing your application servers.
* [x] How to clean up files stored during testing.
* [x] How to implement support for additional storage services.
