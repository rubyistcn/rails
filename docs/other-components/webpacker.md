...
* [x] What Webpacker does and why it is different from Sprockets.
* [x] How to install Webpacker and integrate it with your framework of choice.
* [x] How to use Webpacker for JavaScript assets.
* [x] How to use Webpacker for CSS assets.
* [x] How to use Webpacker for static assets.
* [x] How to deploy a site that uses Webpacker.
* [x] How to use Webpacker in alternate Rails contexts, such as engines or Docker containers.
