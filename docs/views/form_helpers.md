...
* [x] How to create search forms and similar kind of generic forms not representing any specific model in your application.
* [x] How to make model-centric forms for creating and editing specific database records.
* [x] How to generate select boxes from multiple types of data.
* [x] What date and time helpers Rails provides.
* [x] What makes a file upload form different.
* [x] How to post forms to external resources and specify setting an `authenticity_token`.
* [x] How to build complex forms.
