...
* [x] How to use the various rendering methods built into Rails.
* [x] How to create layouts with multiple content sections.
* [x] How to use partials to DRY up your views.
* [x] How to use nested layouts (sub-templates).
