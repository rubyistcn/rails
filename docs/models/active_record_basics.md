...
* [x] What Object Relational Mapping and Active Record are and how they are used in
  Rails.
* [x] How Active Record fits into the Model-View-Controller paradigm.
* [x] How to use Active Record models to manipulate data stored in a relational
  database.
* [x] Active Record schema naming conventions.
* [x] The concepts of database migrations, validations, and callbacks.
