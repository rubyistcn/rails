...
* [x] How to use the built-in Active Record validation helpers.
* [x] How to create your own custom validation methods.
* [x] How to work with the error messages generated by the validation process.
