...
* [x] How an Active Record model behaves.
* [x] How Callbacks and validations work.
* [x] How serializers work.
* [x] How Active Model integrates with the Rails internationalization (i18n) framework.
