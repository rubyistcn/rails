...
* [x] How to find records using a variety of methods and conditions.
* [x] How to specify the order, retrieved attributes, grouping, and other properties of the found records.
* [x] How to use eager loading to reduce the number of database queries needed for data retrieval.
* [x] How to use dynamic finder methods.
* [x] How to use method chaining to use multiple Active Record methods together.
* [x] How to check for the existence of particular records.
* [x] How to perform various calculations on Active Record models.
* [x] How to run EXPLAIN on relations.
