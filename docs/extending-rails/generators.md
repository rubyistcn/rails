...
* [x] How to see which generators are available in your application.
* [x] How to create a generator using templates.
* [x] How Rails searches for generators before invoking them.
* [x] How Rails internally generates Rails code from the templates.
* [x] How to customize your scaffold by creating new generators.
* [x] How to customize your scaffold by changing generator templates.
* [x] How to use fallbacks to avoid overwriting a huge set of generators.
* [x] How to create an application template.
