...
* [x] How to receive email within a Rails application.
* [x] How to configure Action Mailbox.
* [x] How to generate and route emails to a mailbox.
* [x] How to test incoming emails.
