...
* [x] The generators you can use to create them.
* [x] The methods Active Record provides to manipulate your database.
* [x] The rails commands that manipulate migrations and your schema.
* [x] How migrations relate to `schema.rb`.
