...
* [x] The life cycle of Active Record objects.
* [x] How to create callback methods that respond to events in the object life cycle.
* [x] How to create special classes that encapsulate common behavior for your callbacks.
