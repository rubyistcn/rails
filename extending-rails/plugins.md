...
* [x] A way for developers to share bleeding-edge ideas without hurting the stable code base.
* [x] A segmented architecture so that units of code can be fixed or updated on their own release schedule.
* [x] An outlet for the core developers so that they don't have to include every cool new feature under the sun.

After reading this guide, you will know:

* [x] How to create a plugin from scratch.
* [x] How to write and run tests for the plugin.

This guide describes how to build a test-driven plugin that will:

* [x] Extend core Ruby classes like Hash and String.
* [x] Add methods to `ApplicationRecord` in the tradition of the `acts_as` plugins.
* [x] Give you information about where to put generators in your plugin.
