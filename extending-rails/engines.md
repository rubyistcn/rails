...
* [x] What makes an engine.
* [x] How to generate an engine.
* [x] How to build features for the engine.
* [x] How to hook the engine into an application.
* [x] How to override engine functionality in the application.
* [x] How to avoid loading Rails frameworks with Load and Configuration Hooks.
