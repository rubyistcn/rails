...
* [x] What code Rails will automatically execute concurrently
* [x] How to integrate manual concurrency with Rails internals
* [x] How to wrap all application code
* [x] How to affect application reloading
