...
* [x] What instrumentation can provide.
* [x] How to add a subscriber to a hook.
* [x] The hooks inside the Rails framework for instrumentation.
* [x] How to build a custom instrumentation implementation.
