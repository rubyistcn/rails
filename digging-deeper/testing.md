...
* [x] Rails testing terminology.
* [x] How to write unit, functional, integration, and system tests for your application.
* [x] Other popular testing approaches and plugins.
