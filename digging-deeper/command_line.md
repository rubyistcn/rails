...
* [x] How to create a Rails application.
* [x] How to generate models, controllers, database migrations, and unit tests.
* [x] How to start a development server.
* [x] How to experiment with objects through an interactive shell.
