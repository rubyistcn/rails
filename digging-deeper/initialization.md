...
* [x] How to use `bin/rails server`.
* [x] The timeline of Rails' initialization sequence.
* [x] Where different files are required by the boot sequence.
* [x] How the Rails::Server interface is defined and used.
