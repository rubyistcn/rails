---
layout: default
title: Active Record 和 PostgreSQL
nav_exclude: true
---
...
* [x] How to use PostgreSQL's datatypes.
* [x] How to use UUID primary keys.
* [x] How to use deferrable foreign keys.
* [x] How to implement full text search with PostgreSQL.
* [x] How to back your Active Record models with database views.
