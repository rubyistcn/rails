...
* [x] How to set up database encryption with Active Record.
* [x] How to migrate unencrypted data
* [x] How to make different encryption schemes coexist
* [x] How to use the API
* [x] How to configure the library and how to extend it
