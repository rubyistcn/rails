...
* [x] What Rails provides for API-only applications
* [x] How to configure Rails to start without any browser features
* [x] How to decide which middleware you will want to include
* [x] How to decide which modules to use in your controller
