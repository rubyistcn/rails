...
* [x] All countermeasures _that are highlighted_.
* [x] The concept of sessions in Rails, what to put in there and popular attack methods.
* [x] How just visiting a site can be a security problem (with CSRF).
* [x] What you have to pay attention to when working with files or providing an administration interface.
* [x] How to manage users: Logging in and out and attack methods on all layers.
* [x] And the most popular injection attack methods.
...
![Session fixation](../../assets/images/security/session_fixation.png)
...
![Cross-Site Request Forgery](../../assets/images/security/csrf.png)
