...
* [x] How to interpret the code in `config/routes.rb`.
* [x] How to construct your own routes, using either the preferred resourceful style or the `match` method.
* [x] How to declare route parameters, which are passed onto controller actions.
* [x] How to automatically create paths and URLs using route helpers.
* [x] Advanced techniques such as creating constraints and mounting Rack endpoints.
