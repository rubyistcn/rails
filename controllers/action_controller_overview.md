...
* [x] How to follow the flow of a request through a controller.
* [x] How to restrict parameters passed to your controller.
* [x] How and why to store data in the session or cookies.
* [x] How to work with filters to execute code during request processing.
* [x] How to use Action Controller's built-in HTTP authentication.
* [x] How to stream data directly to the user's browser.
* [x] How to filter sensitive parameters, so they do not appear in the application's log.
* [x] How to deal with exceptions that may be raised during request processing.
